...
class MyDotWindow(xdot.DotWindow):
    ...
    def __init__(self):
        ...
        self.tagtree.append_column(gtk.TreeViewColumn("Tags", gtk.CellRendererText(), text=0))
        ...
        vbox.pack_start(self.tagtree)
        vbox.pack_start(self.projecttree)
        hbox.pack_start(vbox, False)
        ...
        hbox.pack_start(TaskProperties)
        vseparator = gtk.VSeparator()
        hbox.pack_start(vseparator, False, padding = 3)
